...
template <class T> // Шаблон функции!
   T abs(T n) // функция типа T и параметром типа T, комплиятор автоматически определяет какой тип будет в этом шаблоне
{
	return (n < 0) ? -n : n; // находим модуль, если положительное, возвращаем входящий аргумент, если отрицательное, возвращаем обратное
}
//---------------------------------------------------------
int main()
{
